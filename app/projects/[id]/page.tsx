...
export default function ProjectDetailPage() {
  ...
  return (
    <div className="space-y-4 rounded-card border border-slate/60 bg-midnight/60 p-8">
      ...
      <div className="rounded-2xl border border-slate/50 bg-slate/60 p-6 text-sm text-cloud/70">
        <p>Mock facts:</p>
