...
export default function Home() {
  return (
    <div className="rounded-card border border-slate/60 bg-midnight/60 p-12 shadow-soft">
      <p className="text-sm uppercase tracking-widest text-gold/70">
        GrantsFound Agentic Platform
      </p>
      <h1 className="mt-4 text-4xl font-display font-semibold text-cloud">
      ...
      <div className="mt-8 flex gap-4">
        ...
        <Link
          href="/agent-hub"
          className="rounded-full border border-cloud/40 px-6 py-3 font-semibold text-cloud focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold"
        >
          View agent hub
        </Link>
      </div>
